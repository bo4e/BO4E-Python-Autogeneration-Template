...
class Fremdkostenposition(BaseModel):
    ...
    .. HINT::
        `Fremdkostenposition JSON Schema <https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/Hochfrequenz/BO4E-Schemas/v202401.0.1-/src/bo4e_schemas/com/Fremdkostenposition.json>`_
    """
